...
## Notes:
* If you want to run your own server, please see [zecwallet lightwalletd](https://github.com/Arrowchain/lightwalletd), and then run `./zecwallet-cli --server http://127.0.0.1:9067`.
...
```
git clone https://github.com/Arrowchain/quiver-light-cli.git
cargo build --release
